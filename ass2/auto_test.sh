...
do
    ...
    do
        ...
        then
            ...
            echo "refer to $flag.$i.$t.cmd" >> $RESULT
        fi
        echo "">>$RESULT
...
rm /import/adams/2/z5089812/tmp/rr
echo "mem:"
grep mem_heap_B  massif.out.* |awk -F '=' '{print $2}'|sort -n|tail -50 >>  /import/adams/2/z5089812/tmp/rr
echo "error: " >>  /import/adams/2/z5089812/tmp/rr
grep "refer to" $RESULT >>  /import/adams/2/z5089812/tmp/rr
echo "end error" >>  /import/adams/2/z5089812/tmp/rr
grep "ms$" $RESULT|awk '{print $1}' |sort -n|tail -50 >> /import/adams/2/z5089812/tmp/rr
